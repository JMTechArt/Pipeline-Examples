...
inputs_path = "C:/Users/count/Desktop/ML/ml_test/python_cloth/dataset/clothtest_v01_inputs_10240_180.raw"
targets_path = "C:/Users/count/Desktop/ML/ml_test/python_cloth/dataset/clothtest_v01_targets_10240_512.raw"
numsamples = 10240
numdims_input = 180
numdims_target = 128

num_epochs = 10000
onnx_path = "C:/Users/count/Desktop/ML/ml_test/python_cloth/onnx/ml_clothtest_v01_"

training_split = 0.8
writer = SummaryWriter("C:/Users/count/Desktop/ML/ml_test/python_cloth/runs/RegressionModel_clothtest_v01")

wedges_hidden_layer_number = [2]
wedges_hidden_layer_dimension = [128]
cache_path = "C:/Users/count/Desktop/ML/ml_test/python_cloth/cache/"
...
with open(targets_path, 'rb') as targets_file:
...
trainin_end = int(round(numsamples * training_split))
training_data = MyDataSet(inputs, targets, 0, trainin_end)
testing_data = MyDataSet(inputs, targets, trainin_end, numsamples)
...
for num_hidden_layers in wedges_hidden_layer_number:
    for num_hidden_dims in wedges_hidden_layer_dimension:
        ...
        for epoch in range(num_epochs):
            ...
            print(nn_name,epoch, my_device, train_loss)
